...
#     CONSTANTES_STATS["joueur"]["pv"][1] = PV_HEROS
#     CONSTANTES_STATS["joueur"]["vitesse"][1] = VITESSE_HEROS
#     CONSTANTES_STATS["joueur"]["force"][1] = FORCE_HEROS
#     CONSTANTES_STATS["joueur"]["regen_pv"][1] = REGEN_HEROS
...
#     dpt_joueur = FORCE_HEROS*TAUX_STOMP*VITESSE_HEROS/LATENCE_STOMP
...
#     print(f"Joueur :         {PV_HEROS:>3} PV, {dpt_joueur:.2f} ({dpt_multi_boost_joueur:.2f}, {dpt_boost_joueur:.2f}) dpt, {REGEN_HEROS} regen")
