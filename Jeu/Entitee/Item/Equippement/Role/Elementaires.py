...
class Rocheux(Equipement):
    ...
    def __init__(self,position:Position,taux_aff_terre:float):
...
class Incandescant(Equipement):
    ...
    def __init__(self,position:Position,taux_aff_feu:float):
        Equipement.__init__(self,position)
...
class Neigeux(Equipement): #"Neigeux" ? "Glaçant" ? "Glacial" ?
    ...
    def __init__(self,position:Position,taux_aff_glace:float):
        Equipement.__init__(self,position)
...
class Tenebreux(Equipement):
    ...
    def __init__(self,position:Position,taux_aff_ombre:float):
        Equipement.__init__(self,position)
