...
from Jeu.Entitee.Item.Equippement.Role.Reparateur.Reparateurs import Renforce_regen_pv
from Jeu.Entitee.Item.Equippement.Role.Reparateur_magique.Reparateurs_magiques import Renforce_regen_pm
