...
if TYPE_CHECKING:
    ...
    from Jeu.Action.Action_skill import Action_skill, Derobe, Blocage, Ramasse, Alchimie
...
from Affichage.Skins.Skins import SKIN_SKILL_DEPLACEMENT, SKIN_SKILL_RAMASSE