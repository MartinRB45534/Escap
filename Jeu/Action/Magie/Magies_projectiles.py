...
from Jeu.Action.Magie.Magie import Magie,Magie_dirigee,Magie_cible_dirigee,Cible_case,Portee_limitee
...
class Magie_boule_de_feu(Magie_dirigee):
    ...
    def __init__(self,skill:Skill_intrasec,agissant:Agissant,niveau:int):
        Magie.__init__(self,skill,agissant,gain_xp_boule_de_feu[niveau-1],cout_pm_boule_de_feu[niveau-1],latence_boule_de_feu[niveau-1])
        self.niveau = niveau
        self.direction = None
        self.temps = 10000
    ...
    def action(self):
        if self.direction is None:
            ...
            self.agissant.controleur.ajoute_entitee(Boule_de_feu(self.agissant.controleur,self.niveau,self.direction,self.agissant,self.agissant.position))
...
class Magie_fleche_de_glace(Magie_dirigee):
    ...
    def __init__(self,skill:Skill_intrasec,agissant:Agissant,niveau:int):
        Magie.__init__(self,skill,agissant,gain_xp_fleche_de_glace[niveau-1],cout_pm_fleche_de_glace[niveau-1],latence_fleche_de_glace[niveau-1])
        self.niveau = niveau
        self.direction = None
        self.temps = 10000
    ...
    def action(self):
        if self.direction is None:
            ...
            self.agissant.controleur.ajoute_entitee(Fleche_de_glace(self.agissant.controleur,self.niveau,self.direction,self.agissant,self.agissant.position))
...
class Magie_rocher(Magie_dirigee):
    ...
    nom = "magie rocher"
    def __init__(self,skill:Skill_intrasec,agissant:Agissant,niveau:int):
        Magie.__init__(self,skill,agissant,gain_xp_rocher[niveau-1],cout_pm_rocher[niveau-1],latence_rocher[niveau-1])
        self.niveau = niveau
        self.direction = None
        self.temps = 10000
    ...
    def action(self):
        if self.direction is None:
            ...
            self.agissant.controleur.ajoute_entitee(Rocher(self.agissant.controleur,self.niveau,self.direction,self.agissant,self.agissant.position))
...
class Magie_ombre_furtive(Magie_cible_dirigee,Cible_case,Portee_limitee):
    ...
    def __init__(self,skill:Skill_intrasec,agissant:Agissant,niveau:int):
        Magie.__init__(self,skill,agissant,gain_xp_ombre_furtive[niveau-1],cout_pm_ombre_furtive[niveau-1],latence_ombre_furtive[niveau-1])
        self.niveau = niveau
    ...
    def action(self):
        if self.direction is None:
            ...
            self.agissant.controleur.ajoute_entitee(Ombre_furtive(self.agissant.controleur,self.niveau,self.direction,self.agissant,self.cible))
...
class Magie_jet_de_mana(Magie_dirigee):
    ...
    def __init__(self,skill:Skill_intrasec,agissant:Agissant,niveau:int):
        Magie.__init__(self,skill,agissant,gain_xp_jet_de_mana[niveau-1],cout_pm_jet_de_mana[niveau-1],latence_jet_de_mana[niveau-1])
        self.niveau = niveau
        self.direction = None
        self.temps = 10000
    ...
    def action(self):
        if self.direction is None:
            ...
            self.agissant.controleur.ajoute_entitee(Jet_de_mana(self.agissant.controleur,self.niveau,self.direction,self.agissant,self.agissant.position))
...
class Magie_eclair_noir(Magie_dirigee):
    ...
    def __init__(self,skill:Skill_intrasec,agissant:Agissant,niveau:int):
        Magie.__init__(self,skill,agissant,gain_xp_eclair_noir[niveau-1],cout_pm_eclair_noir[niveau-1],latence_eclair_noir[niveau-1])
        self.niveau = niveau
        self.direction = None
        self.temps = 10000
    ...
    def action(self):
        if self.direction is None:
            ...
            self.agissant.controleur.ajoute_entitee(Eclair_noir(self.agissant.controleur,self.niveau,self.direction,self.agissant,self.agissant.position))
