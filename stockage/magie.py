...
class MagieAttaqueNivele(MagieNivele):
    ...
    def __init__(self, nom: str, dirigee: bool, distance: bool,
                 latence: list[float], cout_variable: bool, cout: list[float],
