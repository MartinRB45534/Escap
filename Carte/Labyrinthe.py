...
if TYPE_CHECKING:
    ...
    from .Structure_spatiale.Cote import Cote_position,Cote_decalage
...
from .Case import Case
from .Mur import Mur
from .Structure_spatiale.Direction import DIRECTIONS, Direction
from .Structure_spatiale.Position import Position
from .Structure_spatiale.Decalage import Decalage
from .Structure_spatiale.Bord import Bord, Bord_dec, Bord_lab
from .Vue import Representation_vue
import random