...
class Case:
    def __init__(self,position:Position,niveau = 1,element = TERRE,opacite = 1):
        # Par défaut, pas de murs.
        self.position = position
        self.murs = [Mur(position+direction) for direction in Direction]
...
from .Mur import Mur
from .Structure_spatiale.Direction import DIRECTIONS
