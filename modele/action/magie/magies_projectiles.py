...
class ActionMagieProjectileDecentre(InvocationProjectile,CibleCase,PorteeLimitee):
    ...
    def __init__(self,skill:Actif,magie:Magie,agissant:Agissant,gain_xp:float,cout_pm:float,latence:float,entitee:Projectile,direction:crt.Direction,portee:float):
        InvocationProjectile.__init__(self,skill,magie,agissant,gain_xp,cout_pm,latence,entitee,direction)
