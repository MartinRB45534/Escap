...
class Joueur:
    ...
    def debut_tour(self):
        ...
        assert self.affichage is not None
        ...
        while run:
            ...
            if res == False:
                ...
                #     self.boucle()
                    ...
                    ID_MAX.set_id_max(10)
                    self.controleur = Controleur(self.parametres)
                    self.controleurs.append(self.controleur)
                ...
                if nres == False:
                    ...
                    self.controleur = res
                    ID_MAX.set_id_max(max({*self.controleur.agissants.keys()}|{*self.controleur.items.keys()}|{*self.controleur.decors.keys()}))
