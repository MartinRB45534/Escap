from Old_Affichage.Skins.Vue.Skins_vue import *
...
# Actions sur agissant
SKIN_REJOINDRE = Skin("rejoindre.png")
SKIN_PARLER = Skin("parler.png")
SKIN_ATTAQUER = Skin("attaquer.png")
SKIN_AIDER = Skin("aider.png")
SKIN_PRIORISER = Skin("prioriser.png")
SKIN_ANTAGONISER = Skin("antagoniser.png")
SKIN_EXCLURE = Skin("exclure.png")

# Actions sur item
SKIN_EQUIPER_ANNEAU = Skin("equipper_anneau.png")
SKIN_EQUIPER_ARMURE = Skin("equipper_armure.png")
SKIN_EQUIPER_BOUCLIER = Skin("equipper_bouclier.png")
SKIN_EQUIPER_CASQUE = Skin("equipper_casque.png")
SKIN_EQUIPER_EPEE = Skin("equipper_epee.png")
SKIN_EQUIPER_LANCE = Skin("equipper_lance.png")
SKIN_DESEQUIPER_ANNEAU = Skin("desequipper_anneau.png")
SKIN_DESEQUIPER_ARME = Skin("desequipper_arme.png")
SKIN_DESEQUIPER_ARMURE = Skin("desequipper_armure.png")
SKIN_DESEQUIPER_BOUCLIER = Skin("desequipper_bouclier.png")
SKIN_DESEQUIPER_CASQUE = Skin("desequipper_casque.png")
