...
from Old_Jeu.Action.Magie.Magie import Enchante_agissant, Enchante_item
...
class Magie_enchantement_cecite(Enchante_agissant):
    ...
    def get_description(self,observation=0):
        return ["Un enchantement","Affecte un agissant à proximité du lanceur.","L'enchantement de cécité réduit la portée de la vision de l'agissant pour une certaine durée.",f"Coût : {self.cout} PMs",f"Réduction de la vision : {gain_vision_cecite[self.niveau-1]}",f"Durée de l'enchantement : {duree_cecite[self.niveau-1]}",f"Latence : {self.latence}"]
...
class Magie_enchantement_perte_de_pv(Enchante_agissant):
    ...
    def get_description(self,observation=0):
        return ["Un enchantement","Affecte un agissant à proximité du lanceur.","L'enchantement de perte de PVs retire des PVs à l'agissant à chaque tour pour une certaine durée.",f"Coût : {self.cout} PMs",f"PVs perdus par tour : {gain_pv_perte_de_pv[self.niveau-1]}",f"Durée de l'enchantement : {duree_perte_de_pv[self.niveau-1]}",f"Latence : {self.latence}"]
...
class Magie_enchantement_perte_de_pm(Enchante_agissant):
    ...
    def get_description(self,observation=0):
        return ["Un enchantement","Affecte un agissant à proximité du lanceur.","L'enchantement de perte de PMs retire des PMs à l'agissant à chaque tour pour une certaine durée.",f"Coût : {self.cout} PMs",f"PMs perdus par tour : {gain_pm_perte_de_pm[self.niveau-1]}",f"Durée de l'enchantement : {duree_perte_de_pm[self.niveau-1]}",f"Latence : {self.latence}"]
...
class Magie_enchantement_confusion(Enchante_agissant):
    ...
    def get_description(self,observation=0):
        return ["Un enchantement","Affecte un agissant à proximité du lanceur.","L'enchantement de confusion pousse l'agissant à se tromper parfois de direction pour une certaine durée.","L'enchantement ne choisi pas la plus mauvaise direction, mais se contente de modifier la direction de l'agissant, l'agissant peut être quand-même efficace.",f"Coût : {self.cout} PMs",f"Probabilité de se tromper de direction : {taux_erreur_confusion[self.niveau-1]}",f"Durée de l'enchantement : {duree_confusion[self.niveau-1]}",f"Latence : {self.latence}"]
...
class Magie_enchantement_poches_trouees(Enchante_agissant):
    ...
    def get_description(self,observation=0):
        return ["Un enchantement","Affecte un agissant à proximité du lanceur.","L'enchantement de poches trouées pousse l'agissant à laisser parfois tomber des items de son inventaire pour une certaine durée.","L'item laché est choisi aléatoirement, et peut faire partie de l'équippement de l'agissant.",f"Coût : {self.cout} PMs",f"Probabilité de laisser tomber un item : {taux_drop_poches_trouees[self.niveau-1]}",f"Durée de l'enchantement : {duree_poches_trouees[self.niveau-1]}",f"Latence : {self.latence}"]
...
class Magie_enchantement_force(Enchante_agissant):
    ...
    def get_description(self,observation=0):
        return ["Un enchantement","Affecte un agissant à proximité du lanceur.","L'enchantement de force augmente la force de l'agissant pour une certaine durée.",f"Coût : {self.cout} PMs",f"Augmentation de la force : {gain_force[self.niveau-1]}",f"Durée de l'enchantement : {duree_force[self.niveau-1]}",f"Latence : {self.latence}"]
...
class Magie_enchantement_vision(Enchante_agissant):
    ...
    def get_description(self,observation=0):
        return ["Un enchantement","Affecte un agissant à proximité du lanceur.","L'enchantement de vision augmente la portée de la vision de l'agissant pour une certaine durée.",f"Coût : {self.cout} PMs",f"Augmentation de la vision : {gain_vision[self.niveau-1]}",f"Durée de l'enchantement : {duree_vision[self.niveau-1]}",f"Latence : {self.latence}"]
...
class Magie_enchantement_vitalite(Enchante_agissant):
    ...
    def get_description(self,observation=0):
        return ["Un enchantement","Affecte un agissant à proximité du lanceur.","L'enchantement de vitalité donne des PVs à l'agissant à chaque tour pour une certaine durée.",f"Coût : {self.cout} PMs",f"PVs gagnés par tour : {gain_pv_vitalite[self.niveau-1]}",f"Durée de l'enchantement : {duree_vitalite[self.niveau-1]}",f"Latence : {self.latence}"]
...
class Magie_enchantement_absorption(Enchante_agissant):
    ...
    def get_description(self,observation=0):
        return ["Un enchantement","Affecte un agissant à proximité du lanceur.","L'enchantement d'absorption donne des PMs à l'agissant à chaque tour pour une certaine durée.",f"Coût : {self.cout} PMs",f"PMs gagnés par tour : {gain_pm_absorption[self.niveau-1]}",f"Durée de l'enchantement : {duree_absorption[self.niveau-1]}",f"Latence : {self.latence}"]
...
class Magie_enchantement_celerite(Enchante_agissant):
    ...
    def get_description(self,observation=0):
        return ["Un enchantement","Affecte un agissant à proximité du lanceur.","L'enchantement de célérité augmente la vitesse (le taux de diminution de la latence) de l'agissant à chaque tour pour une certaine durée.",f"Coût : {self.cout} PMs",f"Augmentation de la vitesse : {gain_vitesse_celerite[self.niveau-1]}",f"Durée de l'enchantement : {duree_celerite[self.niveau-1]}",f"Latence : {self.latence}"]
...
class Magie_enchantement_flamme(Enchante_agissant):
    ...
    def get_description(self,observation=0):
        return ["Un enchantement","Affecte un agissant à proximité du lanceur.","L'enchantement de flamme augmente l'affinité au feu de l'agissant pour une certaine durée.",f"Coût : {self.cout} PMs",f"Gain d'affinité : {gain_affinite_flamme[self.niveau-1]}",f"Durée de l'enchantement : {duree_flamme[self.niveau-1]}",f"Latence : {self.latence}"]
...
class Magie_enchantement_neige(Enchante_agissant):
    ...
    def get_description(self,observation=0):
        return ["Un enchantement","Affecte un agissant à proximité du lanceur.","L'enchantement de neige augmente l'affinité à la glace de l'agissant pour une certaine durée.",f"Coût : {self.cout} PMs",f"Gain d'affinité : {gain_affinite_neige[self.niveau-1]}",f"Durée de l'enchantement : {duree_neige[self.niveau-1]}",f"Latence : {self.latence}"]
...
class Magie_enchantement_sable(Enchante_agissant):
    ...
    def get_description(self,observation=0):
        return ["Un enchantement","Affecte un agissant à proximité du lanceur.","L'enchantement de sable augmente l'affinité à la terre de l'agissant pour une certaine durée.",f"Coût : {self.cout} PMs",f"Gain d'affinité : {gain_affinite_sable[self.niveau-1]}",f"Durée de l'enchantement : {duree_sable[self.niveau-1]}",f"Latence : {self.latence}"]
...
class Magie_enchantement_tenebre(Enchante_agissant):
    ...
    def get_description(self,observation=0):
        return ["Un enchantement","Affecte un agissant à proximité du lanceur.","L'enchantement de ténèbre augmente l'affinité à l'ombre de l'agissant pour une certaine durée.",f"Coût : {self.cout} PMs",f"Gain d'affinité : {gain_affinite_tenebre[self.niveau-1]}",f"Durée de l'enchantement : {duree_tenebre[self.niveau-1]}",f"Latence : {self.latence}"]
...
class Magie_enchantement_rouille(Enchante_item): #Il faudrait cibler un item visible, équippé par un agissant proche
    ...
    nom = "magie rouille"
    def __init__(self,skill:Actif,agissant:Agissant,niveau:int,cible:Optional[Item]=None):
...
class Magie_enchantement_bombe(Enchante_item):
    ...
    def get_description(self,observation=0):
        return ["Un enchantement","Affecte un item à proximité du lanceur.","L'enchantement de bombe confère un effet explosif à l'item pour une certaine durée (s'il est lancé, il explose au contact d'un agissant ou d'un mur et inflige des dégats de terre aux agissants à proximité).",f"Coût : {self.cout} PMs",f"Dégats de l'explosion : {degats_bombe[self.niveau-1]}",f"Portee de l'explosion : {portee_bombe[self.niveau-1]}",f"Durée de l'enchantement : {duree_bombe[self.niveau-1]}",f"Latence : {self.latence}"]

# Imports utilisés dans le code
from Old_Jeu.Effet.Enchantements import *
from Old_Jeu.Effet.Effets_items import On_hit
from Old_Jeu.Systeme.Constantes_magies.Magies import *
from Old_Affichage.Skins.Skins import SKIN_MAGIE_ENCHANTEMENT_BOMBE,SKIN_MAGIE_ENCHANTEMENT_RENFORCEMENT,SKIN_MAGIE_ENCHANTEMENT_ROUILLE, SKIN_MAGIE_ENCHANTEMENT_FAIBLESSE, SKIN_MAGIE_ENCHANTEMENT_ABSORPTION, SKIN_MAGIE_ENCHANTEMENT_CECITE, SKIN_MAGIE_ENCHANTEMENT_CELERITE, SKIN_MAGIE_ENCHANTEMENT_CONFUSION, SKIN_MAGIE_ENCHANTEMENT_FLAMME, SKIN_MAGIE_ENCHANTEMENT_NEIGE, SKIN_MAGIE_ENCHANTEMENT_SABLE, SKIN_MAGIE_ENCHANTEMENT_TENEBRE, SKIN_MAGIE_ENCHANTEMENT_FORCE, SKIN_MAGIE_ENCHANTEMENT_IMMUNITE, SKIN_MAGIE_ENCHANTEMENT_PERTE_DE_PM, SKIN_MAGIE_ENCHANTEMENT_PERTE_DE_PV, SKIN_MAGIE_ENCHANTEMENT_POCHES_TROUEES, SKIN_MAGIE_ENCHANTEMENT_VISION, SKIN_MAGIE_ENCHANTEMENT_VITALITE