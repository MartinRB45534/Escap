...
from Old_Jeu.Action.Magie.Magie import Invocation_projectile,Cible_case,Portee_limitee
...
from Old_Jeu.Entitee.Item.Projectile.Projectiles import Eclair_noir, Jet_de_mana, Ombre_furtive, Boule_de_feu, Rocher, Fleche_de_glace
from Old_Affichage.Skins.Skins import SKIN_MAGIE_ECLAIR_NOIR, SKIN_MAGIE_BOULE_DE_FEU, SKIN_MAGIE_JET_DE_MANA, SKIN_MAGIE_OMBRE_FURTIVE, SKIN_MAGIE_ROCHER, SKIN_MAGIE_FLECHE_DE_GLACE
from Old_Jeu.Labyrinthe.Structure_spatiale.Position import ABSENT
from Old_Jeu.Labyrinthe.Structure_spatiale.Direction import HAUT