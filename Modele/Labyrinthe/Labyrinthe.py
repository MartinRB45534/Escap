...
class Labyrinthe(crt.Labyrinthe):
    ...
    # def resoud(self,position:crt.Position,portee:float,action="vue",propagation="C__S_Pb",direction:Optional[crt.Direction]=None,dead_ends:Set=set(),reset=True,clees:Set[str]=set()) -> Optional[List[List[Representation_case]]]:
