...
from Old_Jeu.Systeme.Skill_intrasec import *
...
class Skill_attaque(Skill,Skills_offensifs):
    ...
    def fait(self,agissant:Agissant,direction:Direction,arme:Arme):
        return Attaque_arme(agissant,latence_attaque[self.niveau-1],self,gain_xp_attaque[self.niveau-1],taux_utilisation_attaque[self.niveau-1],direction,arme)
